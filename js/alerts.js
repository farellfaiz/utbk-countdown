...
document.querySelector(".learn").addEventListener('click', function() {
    Swal.fire({
        ...
        html: '<div style="text-align:left;">' +
            ...
            '<li><div style="display:flex; align-items:center; justify-content:space-between;">English Grammar<div><a target="_blank" href="https://www.englishgrammar.org/"><span style="margin-left:7px;color:black;text-decoration:none;; font-size:13px;" class="fa fa-external-link"></span><a/></div></div></li>' +
            '<li><div style="display:flex; align-items:center; justify-content:space-between;">IELTS Exam Prep<div><a target="_blank" href="https://www.ielts-exam.net/"><span style="margin-left:7px;color:black;text-decoration:none;; font-size:13px;" class="fa fa-external-link"></span><a/></div></div></li>' +
            '<li><div style="display:flex; align-items:center; justify-content:space-between;">Khan Academy<div><a target="_blank" href="https://www.khanacademy.org/"><span style="margin-left:7px;color:black;text-decoration:none;; font-size:13px;" class="fa fa-external-link"></span><a/></div></div></li>' +
