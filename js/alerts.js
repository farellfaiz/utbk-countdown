...
document.querySelector(".learn").addEventListener('click', function() {
    Swal.fire({
        ...
        html: '<div style="text-align:left;">' +
            ...
            '<li><div style="display:flex; align-items:center; justify-content:space-between;">Zenius<div><a target="_blank" href="https://www.youtube.com/user/ZeniusEduChannel"><span style="margin-left:7px;color:black;text-decoration:none;; font-size:13px;" class="fa fa-external-link"></span><a/></div></div></li>' +
            ...
            '<ul style="margin-top:-15px;">' +
            '<li><div style="display:flex; align-items:center; justify-content:space-between;">Wardaya College<div><a target="_blank" href="https://www.wardayacollege.com/"><span style="margin-left:7px;color:black;text-decoration:none;; font-size:13px;" class="fa fa-external-link"></span><a/></div></div></li>' +
            ...
            '<li><div style="display:flex; align-items:center; justify-content:space-between;">Warga Tiga 2021<div><a target="_blank" href="https://2021.wargati.ga/"><span style="margin-left:7px;color:black;text-decoration:none;; font-size:13px;" class="fa fa-external-link"></span><a/></li>' +
            '<li><div style="display:flex; align-items:center; justify-content:space-between;">UTBK Countdown&apos;s Repository<div><a target="_blank" href="https://github.com/farellfaiz/utbk-countdown/"><span style="margin-left:7px;color:black;text-decoration:none;; font-size:13px;" class="fa fa-external-link"></span><a/></div></div></li></ul>' +
